    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-8 py-12 sm:py-16">
        ...
        <div>
         ...
         <div>
           ...
           <ul className="space-y-2 text-sm text-background/70">
             ...
             <li><Link to="/blog/disturbi-ciclo-mestruale" className="hover:text-background transition-colors">Disturbi del ciclo mestruale</Link></li>
           </ul>
         </div>
      ...
      <div className="border-t border-background/10 mt-10 pt-6 text-center text-xs text-background/50">
        ...
        <div className="mt-3 flex items-center justify-center gap-4">
          ...
          <span className="text-background/30">|</span>
          <a href="https://www.instagram.com/dr.claudiorossi" target="_blank" rel="noopener noreferrer" className="hover:text-background transition-colors">Instagram</a>
          <span className="text-background/30">|</span>
